...
//  This class handles landscape orientation for the Unit Database class, using the landscape version of unit_information_database.xml
//  If only I could get the orientation in the adapter itself, I could combine the two classes.
...
public class RecyclerAdapt2 extends RecyclerView.Adapter<RecyclerAdapt2.MyViewHolder> {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View v) {
            ...
            card.getLayoutParams().height = (int)(.20 * screenHeight);
            card.getLayoutParams().width = (int)(.14 * screenWidth);
            //unitTitle.getLayoutParams().height = (int) (0.03 *screenHeight);
            unitIcon.getLayoutParams().height = (int) (0.14 * screenHeight);
        }
    }

    public RecyclerAdapt2(unitItem[] uArray, Context context) {
        unitArray = uArray;
        mContext = context;
    }

    @Override
    public RecyclerAdapt2.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
